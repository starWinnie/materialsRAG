# 25_ChargE3Net - NMC (Nickel Manganese Cobalt) battery cathode dataset
...
- Paper: [25 ChargE3Net](../papers/25_ChargE3Net.md)
- Task: [task page](../tasks/25_ChargE3Net_task_1.md)
- Dataset: [NMC (Nickel Manganese Cobalt) battery cathode dataset](../datasets/NMC_Nickel_Manganese_Cobalt_battery_cathode_dataset.md)
- Dataset URL: https://doi.org/10.11583/DTU.16837721.v1
...
- Dataset use ID: `dataset_use_8f147f1ffe05`
- Original dataset title: NMC (Nickel Manganese Cobalt) battery cathode dataset
