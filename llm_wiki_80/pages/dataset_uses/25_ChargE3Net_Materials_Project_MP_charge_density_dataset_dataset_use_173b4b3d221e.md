# 25_ChargE3Net - Materials Project (MP) charge density dataset
...
- Dataset: [Materials Project (MP) charge density dataset](../datasets/Materials_Project_MP_charge_density_dataset.md)
- Dataset URL: https://api.materialsproject.org
...
- Dataset use ID: `dataset_use_173b4b3d221e`
- Original dataset title: Materials Project (MP) charge density dataset
