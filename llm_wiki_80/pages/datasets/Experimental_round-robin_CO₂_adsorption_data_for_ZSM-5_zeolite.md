# Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite

## Metadata

- Dataset ID: `dataset_5a37f415d2cf`
- Aliases: Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite
- Links: https://doi.org/10.1007/s10450-018-9952-0
- Used by papers: 1
...
- [28_JARVIS_Leaderboard](../dataset_uses/28_JARVIS_Leaderboard_Experimental_round-robin_CO₂_adsorption_data_for_ZSM-5_zeolite_datas.md): [28 JARVIS Leaderboard](../papers/28_JARVIS_Leaderboard.md), [task](../tasks/28_JARVIS_Leaderboard_task_1.md)
