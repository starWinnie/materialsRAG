...
- Aliases: JARVIS, JARVIS (Joint Automated Repository for Various Integrated Simulations), JARVIS Database, JARVIS Dataset, JARVIS dataset, JARVIS-Tools datasets
