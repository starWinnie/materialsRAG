...
- [08_HiBoFL_Thermal_Conductivity](../dataset_uses/08_HiBoFL_Thermal_Conductivity_HiBoFL_Local_Database_PET-derived_dataset_use_d80d5b12b3a5.md): [08 HiBoFL Thermal Conductivity](../papers/08_HiBoFL_Thermal_Conductivity.md), [task](../tasks/08_HiBoFL_Thermal_Conductivity_task_1.md)
