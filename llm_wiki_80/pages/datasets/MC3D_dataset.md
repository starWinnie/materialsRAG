...
- Dataset ID: `dataset_9a7a3a5a092f`
- Aliases: MC3D dataset
- Links: https://github.com/usnistgov/jarvis/tree/master/jarvis/core
- Used by papers: 1
...
- [06_Transformer_Atomic_Embeddings](../dataset_uses/06_Transformer_Atomic_Embeddings_MC3D_dataset_dataset_use_86b751f702ce.md): [06 Transformer Atomic Embeddings](../papers/06_Transformer_Atomic_Embeddings.md), [task](../tasks/06_Transformer_Atomic_Embeddings_task_1.md)
