...
- Dataset ID: `dataset_176afdea792f`
- Aliases: SuperCon
- Links: https://doi.org/10.48505/nims.3739
- Used by papers: 1
...
- [68_Diffusion models for conditional generation of hypothetical new families of superconductors](../dataset_uses/68_Diffusion_models_for_conditional_generation_of_hypothetical_new_families_of_superconduc.md): [68 Diffusion models for conditional generation of hypothetical new families of superconductors](../papers/68_Diffusion_models_for_conditional_generation_of_hypothetical_new_families_of_superconduc.md), [task](../tasks/68_Diffusion_models_for_conditional_generation_of_hypothetical_new_families_of_superconduc.md)
