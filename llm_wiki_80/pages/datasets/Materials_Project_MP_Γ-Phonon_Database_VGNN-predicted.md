# Materials Project (MP) Γ-Phonon Database (VGNN-predicted)

## Metadata

- Dataset ID: `dataset_cf6d81744e01`
- Aliases: Materials Project (MP) Γ-Phonon Database (VGNN-predicted)
- Links: https://osf.io/k5utb/
- Used by papers: 1
...
- [27_Virtual_Node_Phonon_Preprint](../dataset_uses/27_Virtual_Node_Phonon_Preprint_Materials_Project_MP_Γ-Phonon_Database_VGNN-predicted_data.md): [27 Virtual Node Phonon Preprint](../papers/27_Virtual_Node_Phonon_Preprint.md), [task](../tasks/27_Virtual_Node_Phonon_Preprint_task_1.md)
