...
- Paper file: `12_PDDFormer.pdf`
- Paper ID: `paper_9e212a4383a8`

## Tasks

### [Task 1](../tasks/12_PDDFormer_task_1.md)
...
- Datasets: [Materials Project](../datasets/Materials_Project.md), [JARVIS-DFT](../datasets/JARVIS-DFT.md)
