# 03 Tensorial Spectra

## Metadata

- Paper file: `03_Tensorial_Spectra.pdf`
- Paper ID: `paper_cd706e251a5b`

## Tasks

### [Task 1](../tasks/03_Tensorial_Spectra_task_1.md)
...
- Datasets: [TSENN Dielectric Tensor Dataset](../datasets/TSENN_Dielectric_Tensor_Dataset.md)
