# OFM (Orbital Field Matrix) features

## Metadata

- Dataset ID: `dataset_bb3f8a1b6b1a`
- Aliases: OFM (Orbital Field Matrix) features
- Links: https://doi.org/10.1038/s41524-022-00822-2
- Used by papers: 1
...
- [26_MD_HIT](../dataset_uses/26_MD_HIT_OFM_Orbital_Field_Matrix_features_dataset_use_02aa41f7bc26.md): [26 MD HIT](../papers/26_MD_HIT.md), [task](../tasks/26_MD_HIT_task_1.md)
