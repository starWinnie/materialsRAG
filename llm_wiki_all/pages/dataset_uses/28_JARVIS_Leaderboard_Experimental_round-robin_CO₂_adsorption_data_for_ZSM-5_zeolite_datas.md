...
- Paper: [28 JARVIS Leaderboard](../papers/28_JARVIS_Leaderboard.md)
- Task: [task page](../tasks/28_JARVIS_Leaderboard_task_1.md)
- Dataset: [Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite](../datasets/Experimental_round-robin_CO₂_adsorption_data_for_ZSM-5_zeolite.md)
