...
- Source paper: [03 Tensorial Spectra](../papers/03_Tensorial_Spectra_paper_cd706e251a5b.md)
- Tags: tensor prediction, optical property prediction, symmetry-aware modeling

## Supporting Datasets

### [TSENN Dielectric Tensor Dataset](../datasets/TSENN_Dielectric_Tensor_Dataset_dataset_388341d260b1.md)

- Usage page: [usage note](../dataset_uses/03_Tensorial_Spectra_TSENN_Dielectric_Tensor_Dataset_dataset_use_8162_set_use_81627c0d8816.md)
