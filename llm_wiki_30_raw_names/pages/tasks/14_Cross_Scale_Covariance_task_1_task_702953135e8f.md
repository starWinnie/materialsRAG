...
- Source paper: [14 Cross Scale Covariance](../papers/14_Cross_Scale_Covariance_paper_471a9187e021.md)
- Tags: property prediction, cross-scale modeling, uncertainty quantification

## Supporting Datasets

### [OpenKIM Interatomic Potential Repository](../datasets/OpenKIM_Interatomic_Potential_Repository_dataset_f652501a560b.md)

- Usage page: [usage note](../dataset_uses/14_Cross_Scale_Covariance_OpenKIM_Interatomic_Potential_Repository_da_set_use_172cb9e4ad0d.md)
...
### [Custom DFT dataset for FCC metals](../datasets/Custom_DFT_dataset_for_FCC_metals_dataset_c666648c615a.md)

- Usage page: [usage note](../dataset_uses/14_Cross_Scale_Covariance_Custom_DFT_dataset_for_FCC_metals_dataset_u_set_use_444f94157343.md)
