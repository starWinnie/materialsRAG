...
- Source paper: [31 Superconductivity Ordered Disordered](../papers/31_Superconductivity_Ordered_Disordered_paper_3d03cb8978f0.md)
- Tags: Tc prediction, superconductor screening, disordered structure modeling

## Supporting Datasets

### [SuperCon3D](../datasets/SuperCon3D_dataset_a1d68951db7c.md)

- Usage page: [usage note](../dataset_uses/31_Superconductivity_Ordered_Disordered_SuperCon3D_dataset_use_1ec550_set_use_1ec550fb8fdf.md)
...
### [ICSD (Inorganic Crystal Structure Database)](../datasets/ICSD_Inorganic_Crystal_Structure_Database_dataset_bb8812555b23.md)

- Usage page: [usage note](../dataset_uses/31_Superconductivity_Ordered_Disordered_ICSD_Inorganic_Crystal_Struct_set_use_251f06a78311.md)
...
- Usage page: [usage note](../dataset_uses/31_Superconductivity_Ordered_Disordered_Materials_Project_dataset_use_set_use_9c28764cb72e.md)
...
- Usage page: [usage note](../dataset_uses/31_Superconductivity_Ordered_Disordered_OQMD_Open_Quantum_Materials_D_set_use_bf4439f0a864.md)
...
### [Matgen](../datasets/Matgen_dataset_aed6baa5fc51.md)

- Usage page: [usage note](../dataset_uses/31_Superconductivity_Ordered_Disordered_Matgen_dataset_use_c2144aef17_set_use_c2144aef171b.md)
