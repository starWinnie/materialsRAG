...
- Source paper: [08 HiBoFL Thermal Conductivity](../papers/08_HiBoFL_Thermal_Conductivity_paper_cdf2df178098.md)
...
- Usage page: [usage note](../dataset_uses/08_HiBoFL_Thermal_Conductivity_Materials_Project_MP_database_dataset_set_use_7f5787164691.md)
...
### [HiBoFL Local Database (PET-derived)](../datasets/HiBoFL_Local_Database_PET-derived_dataset_8030c6211eeb.md)

- Usage page: [usage note](../dataset_uses/08_HiBoFL_Thermal_Conductivity_HiBoFL_Local_Database_PET-derived_data_set_use_d80d5b12b3a5.md)
