...
- Dataset ID: `dataset_487cfa495675`
- Aliases: In-house DFT-relaxed novel structures dataset
- Links: None
- Used by papers: 1
...
- [13_CrysCo](../dataset_uses/13_CrysCo_In-house_DFT-relaxed_novel_structures_dataset_dataset_use_2_set_use_2a8c8d9c10db.md): [13 CrysCo](../papers/13_CrysCo_paper_f11b018703ad.md), [task](../tasks/13_CrysCo_task_1_task_f54c6e9beff9.md)
