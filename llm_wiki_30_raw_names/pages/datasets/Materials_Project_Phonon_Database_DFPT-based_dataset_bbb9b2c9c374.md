# Materials Project Phonon Database (DFPT-based)

## Metadata

- Dataset ID: `dataset_bbb9b2c9c374`
- Aliases: Materials Project Phonon Database (DFPT-based)
- Links: None
- Used by papers: 1
...
- [27_Virtual_Node_Phonon_Preprint](../dataset_uses/27_Virtual_Node_Phonon_Preprint_Materials_Project_Phonon_Database_DFP_set_use_4ee42d9fb861.md): [27 Virtual Node Phonon Preprint](../papers/27_Virtual_Node_Phonon_Preprint_paper_1e2428d6caf8.md), [task](../tasks/27_Virtual_Node_Phonon_Preprint_task_1_task_081fca9963b9.md)
