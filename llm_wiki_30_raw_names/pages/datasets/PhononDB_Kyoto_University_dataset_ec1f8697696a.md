# PhononDB (Kyoto University)

## Metadata

- Dataset ID: `dataset_ec1f8697696a`
- Aliases: PhononDB (Kyoto University)
- Links: http://phonondb.mtl.kyoto-u.ac.jp/
- Used by papers: 1
...
- [27_Virtual_Node_Phonon_Preprint](../dataset_uses/27_Virtual_Node_Phonon_Preprint_PhononDB_Kyoto_University_dataset_use_set_use_2f265c920a57.md): [27 Virtual Node Phonon Preprint](../papers/27_Virtual_Node_Phonon_Preprint_paper_1e2428d6caf8.md), [task](../tasks/27_Virtual_Node_Phonon_Preprint_task_1_task_081fca9963b9.md)
