...
- Paper: [20 GMTNet](../papers/20_GMTNet_paper_e25217f4266d.md)
- Task: [task page](../tasks/20_GMTNet_task_1_task_78314418eccc.md)
- Dataset: [JARVIS-DFT dataset](../datasets/JARVIS-DFT_dataset_dataset_238e0bbaedd0.md)
...
- Dataset use ID: `dataset_use_9b85d07df46a`
