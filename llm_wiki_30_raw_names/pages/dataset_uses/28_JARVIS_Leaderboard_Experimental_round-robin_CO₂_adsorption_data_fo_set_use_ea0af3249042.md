# 28_JARVIS_Leaderboard - Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite
...
- Paper: [28 JARVIS Leaderboard](../papers/28_JARVIS_Leaderboard_paper_30ac315b16dd.md)
- Task: [task page](../tasks/28_JARVIS_Leaderboard_task_1_task_933637998dc2.md)
- Dataset: [Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite](../datasets/Experimental_round-robin_CO₂_adsorption_data_for_ZSM-5_zeolite_dataset_5a37f415d2cf.md)
- Dataset URL: https://doi.org/10.1007/s10450-018-9952-0
...
- Dataset use ID: `dataset_use_ea0af3249042`
- Original dataset title: Experimental round-robin CO₂ adsorption data for ZSM-5 zeolite
