# 27_Virtual_Node_Phonon_Preprint - Materials Project (MP) Γ-Phonon Database (VGNN-predicted)
...
- Dataset: [Materials Project (MP) Γ-Phonon Database (VGNN-predicted)](../datasets/Materials_Project_MP_Γ-Phonon_Database_VGNN-predicted_dataset_cf6d81744e01.md)
- Dataset URL: https://osf.io/k5utb/
...
- Dataset use ID: `dataset_use_881abd0f8652`
- Original dataset title: Materials Project (MP) Γ-Phonon Database (VGNN-predicted)
