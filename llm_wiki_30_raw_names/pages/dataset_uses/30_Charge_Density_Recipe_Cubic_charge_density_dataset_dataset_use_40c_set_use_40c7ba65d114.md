# 30_Charge_Density_Recipe - Cubic charge density dataset
...
- Paper: [30 Charge Density Recipe](../papers/30_Charge_Density_Recipe_paper_2532122b8c09.md)
- Task: [task page](../tasks/30_Charge_Density_Recipe_task_1_task_14cc805a3a81.md)
- Dataset: [Cubic charge density dataset](../datasets/Cubic_charge_density_dataset_dataset_06c899bfb490.md)
- Dataset URL: https://doi.org/10.1038/s41597-022-00059-9
...
- Dataset use ID: `dataset_use_40c7ba65d114`
- Original dataset title: Cubic charge density dataset
