# Dataset: MATPES dataset

- Dataset ID: `D_matpes_dataset`
...
- P035 (Correcting DFT formation energies towards experimental accuracy using foundational MLIPs and latent-feature delta-learning): pretraining in Evaluating zero-shot fMLIP formation energies — Train the foundational MLIP PET-OMATPES model at the r2SCAN level, enabling zero-shot formation energy predictions on DFT-relaxed geometries.
