# Stage: collecting labeled crystal property data for fine-tuning and evaluation
...
Acquire labeled datasets containing crystal structures paired with target property values for downstream fine-tuning and benchmarking
...
- JARVIS-DFT dataset (55,722 materials, 19 properties)
- OQMD-EXP dataset (1,500 experimental formation energy values)

## Datasets used

- JARVIS-DFT — training: fine-tuning and evaluation of crystal property prediction on nine target properties
- OQMD-EXP — training: mitigating DFT error by fine-tuning with experimental formation energy data
