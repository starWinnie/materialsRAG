# Dataset Use: matbench_log_gvrh

- DatasetUse ID: `DU_matbench_log_gvrh`
- Dataset: matbench_log_gvrh (`D_matbench_log_gvrh`)
- Papers: P029
- Usage records: 5
...
- Used fields: crystal structure, shear modulus
...
- , PDF page 4, Dataset: "Table 2 | Details of the three benchmark datasets used in this work Dataset Target property Total samples Original source MatBench best algorithm (MAE) Unit matbench_log_gvrh Shear modulus 10987 Materials Project40,70 coNGN36 (0.0670) log10(GPa)"
...
- , PDF page 4, MEGNet: "Table4showsthesummarizedresultsfor ﬁvetypesofOODtestsetson the elasticity dataset."
