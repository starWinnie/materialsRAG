# Dataset: Piezoelectric Tensor

- Dataset ID: `D_piezoelectric_tensor`
...
- P024, PDF page 5, Other DFT-based databases: "Table 3 indicates that TL models outperform the SC models in 10/10 cases, i.e., in 100% of the cases."
- P024, PDF page 9, DATA AVAILABILITY: "The datasets used in this paper are publicly available from the corresponding websites- ... Piezoelectric Tensor46 ... from AutoMatminer63 (https://github.com/hackingmaterials/automatminer)"
