# 05_Thermodynamic_Stability_Ensemble - Double Perovskite Oxides Database (Talapatra et al.)
...
- Dataset: [Double Perovskite Oxides Database (Talapatra et al.)](../datasets/Double_Perovskite_Oxides_Database_Talapatra_et_al.md)
- Dataset URL: None
...
- Dataset use ID: `dataset_use_4c3fc1a3278e`
- Original dataset title: Double Perovskite Oxides Database (Talapatra et al.)
