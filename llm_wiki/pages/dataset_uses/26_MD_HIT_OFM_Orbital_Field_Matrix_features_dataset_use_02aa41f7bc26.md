# 26_MD_HIT - OFM (Orbital Field Matrix) features
...
- Dataset: [OFM (Orbital Field Matrix) features](../datasets/OFM_Orbital_Field_Matrix_features.md)
- Dataset URL: https://doi.org/10.1038/s41524-022-00822-2
...
- Dataset use ID: `dataset_use_02aa41f7bc26`
- Original dataset title: OFM (Orbital Field Matrix) features
