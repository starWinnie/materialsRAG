...
- Source paper: [11 DPF](../papers/11_DPF.md)
- Tags: crystal property prediction, pre-training, denoising reconstruction

## Supporting Datasets

### [380,743 Unlabeled Crystal Structures (Merchant et al. 2023-derived)](../datasets/380_743_Unlabeled_Crystal_Structures_Merchant_et_al._2023-derived.md)

- Usage page: [usage note](../dataset_uses/11_DPF_380_743_Unlabeled_Crystal_Structures_Merchant_et_al._2023-derived_dataset_use_f0b8b.md)
...
- Usage page: [usage note](../dataset_uses/11_DPF_JARVIS_Database_dataset_use_ffc007efd1c1.md)
...
- Usage page: [usage note](../dataset_uses/11_DPF_Materials_Project_dataset_use_b203a6387245.md)
