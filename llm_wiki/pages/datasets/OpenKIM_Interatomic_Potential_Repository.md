# OpenKIM Interatomic Potential Repository

## Metadata

- Dataset ID: `dataset_f652501a560b`
- Aliases: OpenKIM Interatomic Potential Repository
- Links: https://openkim.org
- Used by papers: 1
...
- [14_Cross_Scale_Covariance](../dataset_uses/14_Cross_Scale_Covariance_OpenKIM_Interatomic_Potential_Repository_dataset_use_172cb9e4ad0.md): [14 Cross Scale Covariance](../papers/14_Cross_Scale_Covariance.md), [task](../tasks/14_Cross_Scale_Covariance_task_1.md)
