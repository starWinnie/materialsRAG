# Custom DFT dataset for FCC metals

## Metadata

- Dataset ID: `dataset_c666648c615a`
- Aliases: Custom DFT dataset for FCC metals
- Links: None
- Used by papers: 1
...
- [14_Cross_Scale_Covariance](../dataset_uses/14_Cross_Scale_Covariance_Custom_DFT_dataset_for_FCC_metals_dataset_use_444f94157343.md): [14 Cross Scale Covariance](../papers/14_Cross_Scale_Covariance.md), [task](../tasks/14_Cross_Scale_Covariance_task_1.md)
